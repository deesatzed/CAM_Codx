...
Use only the request below. Do not use XTtapeNotes.md. Do not query CAM, claw.db, or any external memory system. Do not write app code.
...
After writing them, provide a short summary of the major architecture stance and any blockers.
