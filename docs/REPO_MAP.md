...
CAM_CAM -> mined methodology -> CAM_Codx -> planning showpiece -> product build contract
```
...
| `/Volumes/WS4TB/ccxt` | Local XTtape showpiece cockpit used for the published CAM-vs-vanilla planning comparison. |
...
| Path | Purpose |
|---|---|
| `docs/showpieces/xttape-cam-comparison` | Completed XTtape vanilla-vs-CAM planning comparison, final build brain, evidence, and next implementation plan. |
| `docs/examples/XTTAPE_CAM_SHOWPIECE_CASE_STUDY.md` | Novice-facing explanation of what the XTtape result proves and what it does not prove. |
